\chapter{The Deep Controlled 2BSDE Method} \label{sec:2bsde}
...
\section{Applying the Algorithm to the Unconstrained Case}
...
\subsection*{Extending the Algorithm to the Dual Problem}
...
\section{Verifying Results with Analytical Solution}
